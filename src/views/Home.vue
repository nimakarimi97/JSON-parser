...
<template>
  <div class="home-container" @keydown="handleKeyDown">
    <header>
    ...
    <main>
      <div class="editor-container">
        <div class="panel source-panel">
          ...
          <JsonInput v-model="jsonStore.sourceJson" placeholder="Paste your JSON here..." @format="jsonStore.formatJson" />
        </div>
